...
export const NN_STATES = [
  {
    ...
    checklist: [
      ...
      { key: 'nonce_generated',   label: 'Show nonce generated',            owner: 'auto' },
      { key: 'urls_distributed',  label: 'URLs posted to comms',            owner: 'auto' },
      { key: 'qr_verified',       label: 'QR code scanned & verified',      owner: 'boss' },
